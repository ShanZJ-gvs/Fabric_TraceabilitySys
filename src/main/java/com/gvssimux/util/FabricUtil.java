...
*/
     ...
     * */
    public static org.hyperledger.fabric.client.Contract getContract() throws Exception {
        FabricGateway fabricGateway = new FabricGateway();
        org.hyperledger.fabric.client.Contract contract = fabricGateway.getContract();
        return  contract;
    }
